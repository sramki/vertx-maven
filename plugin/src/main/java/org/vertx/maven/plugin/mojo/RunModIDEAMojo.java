 ...
 */
@Mojo(name = "runModIDEA", requiresProject = true, threadSafe = false, requiresDependencyResolution = COMPILE_PLUS_RUNTIME)
  ...
  public void execute() throws MojoExecutionException {
    try {
      URL[] classpath = new URL[]{ new URL("file:src/main/resources/"), new URL("file:src/test/resources/"),
          new URL("file:target/classes/"), new URL("file:target/test-classes/") };
      doExecute(classpath);
